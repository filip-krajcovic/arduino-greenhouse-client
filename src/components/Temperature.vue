  ...
  <div class="flex py-2 flex-col border rounded-xl border-neutral-300 dark:bg-neutral-800 dark:border-neutral-800">
      <div class="flex items-center pl-2">
        ...
        <div class="flex flex-col">
          <p class="font-bold text-sm text-black/70 dark:text-white font-black tracking-tighter">{{ $t('temperature') }}</p>
            <TimeAgo v-if="temperature?.timestamp" :datetime="temperature?.timestamp" class="h-5 text-xs text-neutral-400"/>
