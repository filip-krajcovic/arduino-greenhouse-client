...
<template>
  <div class="px-4">
    <div v-if="data">
      ...
      <h1 class="font-bold text-3xl tracking-wide text-black/90 pb-1 dark:text-white">
        {{ data.name.sk }}
      </h1>
      <span class="text-black/60 italic dark:text-neutral-200">{{ data.name.latin }}</span>
      <div class="pt-8">
