...
<template>
  <div>
    <button class="vt-switch vt-switch-appearance dark:bg-neutral-800 border border-neutral-500" type="button" @click="toggleDark()">
      <span class="vt-switch-check">
        <span class="vt-switch-icon dark:bg-neutral-500">
