...
<template>
  ...
  <div class="grid grid-cols-1 gap-4 px-2 pb-8">
    <div v-if="measurements && measurements.length > 0" v-for="(item, index) in measurements" class="p-4 shadow-[0px_0px_15px_-3px_rgba(0,0,0,0.15)] rounded-2xl dark:bg-neutral-800 text-sm">
