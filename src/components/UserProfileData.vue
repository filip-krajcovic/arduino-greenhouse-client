...
<template>
  ...
  <div class="pt-5">
      <span class="text-black/80 dark:text-neutral-300 font-light text-sm">Email</span>
  </div>
  <div class="pt-3 pb-1">
  ...
  <div class="pt-6">
      <span class="text-black/80 dark:text-neutral-300 font-light text-sm">Meno</span>
  </div>
  <div class="pt-3 pb-1">
  ...
  <div class="h-px bg-neutral-300 dark:bg-neutral-600"></div>
  <div class="pt-6">
      <span class="text-black/80 dark:text-neutral-300 font-light text-sm">Priezvisko</span>
  </div>
  <div class="pt-3 pb-1">
