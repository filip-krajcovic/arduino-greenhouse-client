...
<template>
  <div class="flex flex-col">
    ...
    <div class="inline-flex drop-shadow-[0_2px_4px_rgba(0,0,0,0.18)] pt-2">
      ...
      <button @click="openWindow()" type="button" class="bg-gray-300 dark:bg-cyan-800 rounded-r-lg py-3 px-3 hover:bg-green-600 dark:hover:bg-green-600 hover:text-white">Otvoriť</button>
    </div>
